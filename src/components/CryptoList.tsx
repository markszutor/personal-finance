...
export function CryptoList() {
  ...
  const cryptoInvestments = allInvestments.filter(inv => inv.type === 'crypto')

  // Filter investments based on search
  const filteredInvestments = cryptoInvestments.filter(investment => {
      ...
      <div style={{
        ...
        <div>
          ...
          <p style={{
            ...
            Track your cryptocurrency investments and portfolio
          </p>
        </div>
        <DateFilter 
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{
            ...
            {filteredInvestments.length} cryptocurrencies
          </div>
        </div>
          ...
          <div style={{
            ...
            <p style={{
              ...
              {searchTerm 
                ...
                : 'Add your first cryptocurrency investment to start building your portfolio!'
              }
            </p>
          </div>
        ) : (
                  ...
                  <div style={{
                    ...
                    <div style={{ flex: 1 }}>
                      ...
                      <div style={{
                        ...
                        <span>{investment.quantity} coins</span>
                        <span>•</span>
        ...
        <div style={{
          ...
          <div style={{
            ...
            <p style={{
              ...
              Are you sure you want to delete this cryptocurrency investment? This action cannot be undone.
            </p>
